...
?>
        ...
        <div class="posts">
          ...
          <article class="post">
            ...
            <a href="article.php?id=4" class="post__link">Continue reading</a>
          </article>
          <article class="post">
            <a href="" class="post__category post__category--color-team">team</a>
            ...
            <a href="article.php?id=5" class="post__link">Continue reading</a>
          </article>
          <article class="post">
            <a href="" class="post__category post__category--color-work">work</a>
            ...
            <a href="article.php?id=6" class="post__link">Continue reading</a>
          </article>
        </div>
